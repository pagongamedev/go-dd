...
func handlerDefaultValidateResponse() ValidateResponse {
	return func(context *godd.Context, code int, responseMapping interface{}, responsePagination *godd.ResponsePagination) (codeOut int, responseValidated interface{}, responsePaginationOut *godd.ResponsePagination, goddErr *godd.Error) {
