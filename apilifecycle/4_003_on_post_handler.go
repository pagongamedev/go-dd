...
func handlerDefaultOnPostHandler() OnPostHandler {
	return func(context *godd.Context, code int, responseRaw interface{}, responsePaginationIn *godd.ResponsePagination) (codeOut int, responseRawOut interface{}, responsePaginationOut *godd.ResponsePagination, goddErr *godd.Error) {
