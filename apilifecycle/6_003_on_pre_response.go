...
// OnPreResponse Type
type OnPreResponse = func(context godd.InterfaceContext, code int, requestValidatedIn interface{}) (codeOut int, requestValidatedOut interface{}, goddErr *godd.Error)
...
func handlerDefaultOnPreResponse() OnPreResponse {
	return func(context godd.InterfaceContext, code int, responseStandard interface{}) (codeOut int, responseStandardOut interface{}, goddErr *godd.Error) {
